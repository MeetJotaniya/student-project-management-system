...
export default function ManageStudentsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let imageUrl = '';
      if (profileImage) {
        imageUrl = '/uploads/profiles/' + profileImage.name;
      }

      const url = modalMode === 'add'
        ? '/api/admin/register-student'
        : `/api/admin/students/${selectedStudent?.studentid}`;
      ...
      if (response.ok) {
        alert(`Student ${modalMode === 'add' ? 'added' : 'updated'} successfully!`);
        closeModal();
        fetchStudents();
      } else {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">View, add, edit, and delete student records</p>
            </div>
          </div>
          <button
        ...
        <div className="mb-6">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white text-sm w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    {imagePreview ? (
                      ...
                      <div className="w-20 h-20 bg-slate-600 rounded-full flex items-center justify-center border-4 border-slate-600">
